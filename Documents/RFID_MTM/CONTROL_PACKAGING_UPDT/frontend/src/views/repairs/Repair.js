...
const Repair = () => {
  ...
  const columns = [
    ...
    { name: "Asset Code", selector: row => row.asset_code },
    { name: "Repair Type", selector: row => row.repair_type },
    { name: "Location", selector: row => row.location },
    { name: "Notes", selector: row => row.notes },
    { name: "Status", selector: row => row.status },
    { name: "Repair Date", selector: row => row.repair_date },
    { name: "Finished At", selector: row => row.finished_at || "-" },
    {
      name: "Aksi",
      cell: row => (
        row.status === "ongoing" ? (
