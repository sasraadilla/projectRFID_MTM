...
const AddActualPackaging = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post("/actual-packaging", form);
      Swal.fire("Berhasil", "Data actual ditambahkan", "success")
  ...
  return (
    <CRow>
      <CCol xs={6}>
        <CCard>
          <CCardHeader><strong>Tambah Actual Packaging</strong></CCardHeader>
          <CCardBody>
...
export default AddActualPackaging;
